...
namespace DAL.Migrations
{
    ...
    [Migration("20250514221432_15052025_4")]
    partial class _15052025_4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.DB.AISetting", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("kfold")
                        .HasColumnType("int");

                    b.Property<int>("mtry")
                        .HasColumnType("int");

                    b.Property<int>("ntree")
                        .HasColumnType("int");

                    b.Property<int>("status")
                        .HasColumnType("int");

                    b.Property<bool>("testCSV")
                        .HasColumnType("bit");

                    b.Property<decimal>("threshold")
                        .HasColumnType("decimal(18,2)");

                    b.Property<bool>("trainCSV")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Entities.DB.Plate", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.DB.Task", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.DB.TaskComment", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.DB.OrderItem", b =>
                {
                    ...
                    b.HasOne("Entities.DB.Plate", "plate")
                        .WithMany()
            ...
            modelBuilder.Entity("Entities.DB.Task", b =>
                {
                    b.HasOne("Entities.DB.OrderItem", "orderItem")
                        .WithMany()
            ...
            modelBuilder.Entity("Entities.DB.TaskComment", b =>
                {
                    b.HasOne("Entities.DB.Task", "task")
                        .WithMany()
